...
function Pickup() {
  ...
  const { id } = useParams();
  const pickup = mockPickup; // In real app, fetch by id

  return (
    <EndUserLayout>
      {/* Pickup Info */}
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <div className="text-lg font-bold mb-2">Order: {pickup.id}</div>
      ...
      <div className="flex gap-2">
        ...
        <button
          onClick={() => navigate(`/orders/${pickup.id}`)}
