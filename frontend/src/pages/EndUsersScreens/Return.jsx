...
function Return() {
  ...
  const { id } = useParams();
  const ret = mockReturn; // In real app, fetch by id

  return (
    <EndUserLayout>
      {/* Return Info */}
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <div className="text-lg font-bold mb-2">Order: {ret.id}</div>
        <div className="text-gray-500 mb-2">Return Address: {ret.address}</div>
